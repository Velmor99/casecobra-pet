...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidhWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidhWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="test-lg leading-8">
                <p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="test-lg leading-8">
                <p>
                  ...
                  last phone cases. This one besides a berely noticeable scratch
                  on the corner,{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
      ...
      <section>
        <MaxWidhWrapper className="py-24">
